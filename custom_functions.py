...
def create_assistant(client):
  ...
  if os.path.exists(assistant_file_path):
    ...
    # To change the rag document, modifiy the file name below to match your document
    # If you want to add multiple files, paste this function into ChatGPT and ask for it to add support for multiple files
    file = client.files.create(file=open("rag.docx", "rb"),
                               purpose='assistants')
    ...
    assistant = client.beta.assistants.create(
        ...
        tools=[
            {
                "type": "file_search"  # This adds the rag base as a tool
            },
            {
